...
<a href='https://www.kaggle.com/datasets/uom190346a/water-quality-and-potability'>Water Quality and Potability</a>
...
km <- kmeans(data_for_cluster, centers = k,nstart=25) # if centers is a number, how many random sets should be chosen?
ss <- silhouette(km$cluster, dist(data_for_cluster))
sil<- mean(ss[, 3])
return(sil)
}
...
# Gap statistic
set.seed(123)
fviz_nbclust(data_for_cluster, kmeans, nstart = 25,  method = "gap_stat", nboot = 500, verbose = FALSE)+
