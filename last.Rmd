...
|-------------|-------------------|-------------|-------------|
| Accuracy    | 0.5863            | 0.9223      | 0.5996      |
| precision   | 0.5943            | 0.9167      | 0.6064      |
| sensitivity | 0.9421            | 0.9597      | 0.9164      |
| specificity | 0.0741            | 0.8640      | 0.1435      |
...
![](Image/Clustering/all class.png){width="550"}
...
![](Image/Clustering/all cluster.png){width="500"}
